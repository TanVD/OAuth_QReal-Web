  ...
  <div class="row">
    <form role="form" class="col-md-9 go-right" action="servers/newServerAdded" method="post">
      ...
      <div class="form-group">
        ...
        <label for="name">Server's name</label>
      </div>
      <div class="form-group">
        <input id="ip" name="ip" type="text" class="form-control" placeholder="Server's IP" required>
        <label for="ip">Server's IP</label>
      </div>
      <div class="form-group">
        <input id="format" name="format" type="text" class="form-control" placeholder="Server's format"  required>
