...
public class AdminController {
    ...
    public void startCaching() throws Exception {
        myUserApprovalHandler.setUseApprovalStore(true);
    }

    @RequestMapping("/oauth/uncache_approvals")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void stopCaching() throws Exception {
        myUserApprovalHandler.setUseApprovalStore(false);
    }
    ...
    /**
     * @param myUserApprovalHandler the myUserApprovalHandler to set
     */
    public void setMyUserApprovalHandler(MyUserApprovalHandler myUserApprovalHandler) {
        this.myUserApprovalHandler = myUserApprovalHandler;
    }
